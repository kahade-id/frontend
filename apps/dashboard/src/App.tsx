...
// FIX (Issue #5): AcceptTransactionInvite must be imported and used below
          ...
          <TooltipProvider>
            ...
            <Suspense fallback={<PageLoader />}>
              <Switch>
                ...
                {/* FIX (Issue #5): Specific/static transaction routes MUST come
                    before the parameterized /:id route, otherwise wouter will
                    match /transactions/create and /transactions/invite/:token
                    as transaction IDs and render the wrong component. */}
                <Route path="/transactions/create">
                  <ProtectedRoute><CreateTransaction /></ProtectedRoute>
                </Route>
                <Route path="/transactions/invite/:token">
                  <ProtectedRoute><AcceptTransactionInvite /></ProtectedRoute>
                </Route>
                {/* Parameterized route comes AFTER static segments */}
                ...
                <Route path="/disputes/:id">
                  <ProtectedRoute><DisputeDetail /></ProtectedRoute>
                </Route>
                <Route path="/disputes">
                ...
                <Route path="/rewards/points">
                  <ProtectedRoute><RewardPoints /></ProtectedRoute>
                </Route>
                <Route path="/rewards/rank">
                  <ProtectedRoute><RewardRank /></ProtectedRoute>
                </Route>
                <Route path="/rewards/missions">
                  <ProtectedRoute><RewardMissions /></ProtectedRoute>
                </Route>
                ...
                <Route path="/security">
                  <ProtectedRoute><MFASettings /></ProtectedRoute>
                </Route>
                <Route path="/messages">
