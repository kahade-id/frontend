...
export default function HeroSection() {
  ...
  return (
    <section className="section-padding-hero relative overflow-hidden">
      {/* Background grid — contained layer, not repainted on scroll */}
      <div
      ...
      />
      {/* Gradient blobs — GPU-accelerated, reduced blur radius for perf on low-mid devices */}
      <div
        className="absolute -top-10 right-0 w-[260px] h-[260px] sm:w-[380px] sm:h-[380px] lg:w-[520px] lg:h-[520px] rounded-full pointer-events-none"
        aria-hidden="true"
        style={{
      ...
      />
      <div
        className="absolute -bottom-16 left-0 w-[200px] h-[200px] sm:w-[280px] sm:h-[280px] lg:w-[360px] lg:h-[360px] rounded-full pointer-events-none"
        aria-hidden="true"
        style={{
          background: 'radial-gradient(circle, var(--muted) 0%, transparent 70%)',
          opacity: 0.3,
