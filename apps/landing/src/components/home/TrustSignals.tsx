  ...
  return (
    <div className="border-t border-border py-3 bg-background" aria-label="Aktivitas transaksi terbaru (simulasi)">
      <div className="container">
        ...
        <p className="text-center text-xs text-muted-foreground/60 mt-1">Geser horizontal untuk melihat semua aktivitas →</p>
      </div>

      <p className="text-center text-[0.6875rem] text-muted-foreground/50 mt-2">
