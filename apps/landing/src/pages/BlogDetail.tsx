...
export default function BlogDetail() {
 ...
 <section className="section-padding-md"><div className="container max-w-2xl mx-auto text-center"><h2 className="text-2xl font-bold mb-4">Mulai transaksi aman bersama Kahade</h2><Button asChild variant="primary" className="inline-flex items-center"><a href="https://app.kahade.id/register" >Daftar Gratis <ArrowRight size={16} /></a></Button></div></section>
 <Footer /></div>);
}