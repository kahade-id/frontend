...
export default function IntegrationDocs() {
 ...
 <Button asChild  variant="primary" className="w-full sm:w-auto"><Link href="/docs/api" className="block">
 <Code className="mr-2 w-4 h-4" weight="duotone" aria-hidden="true" />
 Referensi API Lengkap
 </Link></Button>
 <Button asChild variant="outline" className="w-full sm:w-auto"><Link href="/docs" className="block">
