...
export default function Partners() {
 ...
 {/* HERO */}
 <PageHero eyebrow="Kemitraan" title="Ekosistem Partner Kahade" description="Program kemitraan untuk memperluas layanan, distribusi, dan adopsi transaksi aman bersama Kahade." chips={[{ label: 'Program Partner' }, { label: 'Integrasi' }, { label: 'Co-Marketing' } ]} />
