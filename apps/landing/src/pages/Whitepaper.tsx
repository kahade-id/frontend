...
export default function Whitepaper() {
 ...
 <Button asChild className="h-11 md:h-12 px-6 md:px-8 bg-card text-foreground hover:bg-gray-100 font-semibold rounded-xl gap-2">
 <Link href="/contact">
 Contact Us
 <ArrowRight className="w-5 h-5" aria-hidden="true" weight="bold" />
 </Link>
 </Button>
 <Button asChild variant="outline" className="h-11 md:h-12 px-6 md:px-8 bg-transparent text-white border-white/30 hover:bg-white/10 font-semibold rounded-xl">
 <Link href="/about">About Kahade</Link>
 </Button>
 </div>
 </motion.div>
 </div>
