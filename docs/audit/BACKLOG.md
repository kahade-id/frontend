...
| 10 | token | Inline `style={}` numerik | **Selesai** (2 literal diperbaiki, slider geometri → `tokens.space`, `check:tokens` #11 multi-baris + allowlist typo, lihat `findings/10-inline-style-numeric.md`) |
